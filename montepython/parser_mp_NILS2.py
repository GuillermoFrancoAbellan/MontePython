...
def create_parser():
    ...
    **run**
        ...
        <**>--minimizer<**> : str
            <++>Which minimizer to use<++> Used by option --minimize (Default: Nelder-Mead)<++>
        <**>--minimize-tol<**> : float
    ...
    **info**
    ...
    runparser.add_argument('--minimizer', help=helpdict['minimizer'], type=str,
                           dest='minimizer', default="Nelder-Mead")
    # -- minimize argument, minimization procedure type (OPTIONAL)
    ...
    ###############
    # Factor the likelihood difference for minimum finding
