...
s_pl15  = loadMCSamples('/home/fabellan/montepython_public/chains/decay_nu_full_Pl15_bao_sn_FULL_RANGE/2021-12-20_2000000_', settings = settings)
s_pl18  = loadMCSamples('/home/fabellan/montepython_public/chains/decay_nu_full_Pl18_bao_sn_FULL_RANGE/2021-12-20_2000000_', settings = settings)
...
s_pl15.setRanges({'Log10_Gamma':(0.1,6.5)})
s_pl18.setRanges({'Log10_Gamma':(0.1,6.5)})
...
rec.settings.legend_fontsize = 12
...
rec.triangle_plot([s_pl15,s_pl18],params_to_plot,filled=[True,True],legend_labels = ['Planck 2015 + BAO/$f\sigma_8$ + Pantehon','Planck 2018 + BAO/$f\sigma_8$ + Pantehon'],contour_colors = ['red','blue'])
...
rec.export('decaying_nu_comparison_FULL_RANGE.pdf')
