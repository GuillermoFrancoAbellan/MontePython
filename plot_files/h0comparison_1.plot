...
info.redefine = {'YHe': '1.-Omega_Lambda','sigma8':'sigma8*np.sqrt((1.-Omega_Lambda)/0.3)'}
...
info.to_change = {'YHe': 'Omega_m','sigma8':r'$S_8$',
                  'H0':r'$H_0$','b_clump':r'$b$','b_clump':r'$b$' }
...
info.to_plot = [r'$H_0$','Omega_m',r'$S_8$',r'$b$']
info.legendnames = [r'PlanckTT',r'PlanckTTTEEE',r'PlanckTTTEEE+Lens',r'PlanckTTTEEE+Lens+BAO']
...
info.MP_color_cycle = [info.MP_color['Red'], info.MP_color['Blue'], info.MP_color['Green'], info.MP_color['Orange'],  info.MP_color['Purple'], info.MP_color['LRed'], info.MP_color['LBlue'],info.MP_color['DGreen'],info.MP_color['DOrange'], info.MP_color['Grey'], info.MP_color['Black'],info.MP_color['Pink'],info.MP_color['Magenta']]
...
#info.force_limits = {'Omega_m':[0.18125,0.36875], r'$H_0$':[62.0,82.0],r'$S_8$':[0.68125,0.86875],r'$b$':[-0.0375,3.3375]}
info.force_limits = {'Omega_m':[0.2375,0.3625], r'$H_0$':[63.75,76.25],r'$S_8$':[0.68125,0.86875],r'$b$':[-0.0375,3.3375]}
