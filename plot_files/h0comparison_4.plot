...
#info.to_change = {'Omega_m': r'$\Omega_m$','M':r'$M_B$','H0':r'$H_0$','b_clump':r'$b$'}
info.to_change = {'Omega_m': r'$\Omega_m$','M':r'$M_B$','H0':r'$H_0$',
                  'parameters_smg__2':r'$\xi$','indexg_V':r'$V_0$', 'thetai_scf':r'$\sigma_i$' }
...
#info.to_plot = [r'$H_0$',r'$M_B$',r'$\Omega_m$',r'$b$']
info.to_plot = [r'$H_0$',r'$M_B$',r'$\Omega_m$',r'$\xi$', r'$V_0$', r'$\sigma_i$']
#info.legendnames = [r'BBN+BAO+Ly$\alpha$+Pantheon+CC',r'WMAP+ACT+BAO+Pantheon+$\tau$',r'P18+BAO+Pantheon']
#info.legendnames = [r'BBN+BAO+Ly$\alpha$+Pantheon+CC',r'P18+BAO+Pantheon']
info.legendnames = [r'BBN+BAO+Ly$\alpha$+Pantheon+CC']
...
#info.force_limits = {r'$\Omega_m$':[0.2375,0.3625], r'$H_0$':[63.75,76.25],r'$b$':[0.1,1.1],r'$M_B$':[-19.5375,-19.1625]}
info.force_limits = {r'$\Omega_m$':[0.2375,0.3625], r'$H_0$':[63.75,76.25],r'$\xi$':[0.00375,0.66625],r'$V_0$':[0.9375,3.5625],r'$\sigma_i$':[0.0125,0.8875],r'$M_B$':[-19.5375,-19.1625] }
